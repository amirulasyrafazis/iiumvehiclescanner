...
<div id="log">
<a href="index.php">Home</a> | Add Vehicle | <a href="doctype.php">User Type</a> | <a href="offices.php">Generate Sticker</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search Vehicle Type..." autocomplete="off" />
<a rel="facebox" href="addoffice.php" id="add">Add Vehicle</a>
</div>
