...
<div id="log">
<a href="index.php">Home</a> | <a href="offices.php">Add Vehicle</a> | User Type | <a href="pull.html">Generate Sticker</a> | <a href="../index.php">Logout</a>
</div>
<div id="formdesign">
<input type="text" name="filter" value="" id="filter" placeholder="Search User Type..." autocomplete="off" />
<a rel="facebox" href="adddoc.php" id="add">Add User Type</a>
</div>
